              ...
              {activeTab === 'bio' ? (
                <div className="space-y-4 font-serif">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2 font-sans">
                    ...
                    >
                      ...
                      <span>DOWNLOAD RESUME / MANIFEST (.TXT)</span>
                    </button>
                    <button 
                ...
                <div className="grid grid-cols-2 gap-4 font-serif">
                  <div className="flex items-center space-x-3 p-3 rounded-sm border border-art-beige-mid bg-art-beige-light/20">
                    ...
                    <div>
                      <div className="text-[9px] font-mono text-art-charcoal/40 uppercase">AWS HOST</div>
                      <div className="text-sm font-semibold text-art-charcoal">CLOUD SERVERS</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 rounded-sm border border-art-beige-mid bg-art-beige-light/20">
